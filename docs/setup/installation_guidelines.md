...
**SOC tips** If you're using the battery with a solar system, it's very likely that in summer it will charge up very early during the day. For batteries of NMC chemistries it's specifically advised against habitual full charging, which adds wear - thus, for longer lifetime, you should set **SOC max percentage** to around **80** during the summer, when the pack charges to full quickly and then stays full almost all day, with shorter night times. Raise it higher during the winter as it likely charges slower, plus longer nights need more energy than during summer.
